...
const SpeciesList = require('../public/javascripts/data/speciesList');
...
DataSource.prototype = {
    ...
    accessMongo : function(callback) {
        if (this.reader === null) {
            this.reader = new DataReader(new Attributes());
        }
        var attrib = this.attrib;
        this.reader.getMongoFromExp('default', 'test_data_01', function(result) {
            attrib = result;
            callback();
        });
    }
