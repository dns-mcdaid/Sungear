...
var hereWeGo = new p5(function(p5) {
    ...
    p5.draw = function() {
        ...
        selB.paintIcon(null, p5, 35.5, HEIGHT-22);
        nextB.paintIcon(null, p5, 45, HEIGHT-30);

        toggleArrows.paintIcon(null, p5, 20, HEIGHT-50);
        min.paintIcon(null, p5, 20, HEIGHT-75);
        statsB.paintIcon(null, p5, 13, HEIGHT-108);
    };
